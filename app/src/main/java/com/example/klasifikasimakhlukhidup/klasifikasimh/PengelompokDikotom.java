...
public class PengelompokDikotom extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pengelompok_dikotom);
    }
...
//                    mp.start();
                    Intent i = new Intent(PengelompokDikotom.this, UrutanTaksonHewanDanTumbuhan.class);
                    startActivity(i);
                ...
                //kiri
                    ...
                    Intent i = new Intent(PengelompokDikotom.this, TataCaraPemberian.class);
                    startActivity(i);
