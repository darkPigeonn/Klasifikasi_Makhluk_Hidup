...
public class ManfaatDanKlasifikasi extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_manfaat_dan_klasifikasi);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuutama:
                startActivity(new Intent(ManfaatDanKlasifikasi.this, hal2_menuutama.class));
                finish();
            case R.id.menumateribarr:
                startActivity(new Intent(ManfaatDanKlasifikasi.this, hal10_menumateri.class));
                finish();
        }
        return false;
    }
...
//                    mp.start();
                ...
                //kiri
                    ...
                    Intent i = new Intent(ManfaatDanKlasifikasi.this, urutan_takson_determinasi.class);
                    startActivity(i);
