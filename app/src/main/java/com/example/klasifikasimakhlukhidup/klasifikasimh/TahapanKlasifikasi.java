...
public class TahapanKlasifikasi extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    float x1,x2,y1,y2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tahapan_klasifikasi);
    }
...
//                    mp.start();
                    Intent i = new Intent(TahapanKlasifikasi.this, urutan_takson_determinasi.class);
                    startActivity(i);
                ...
                //kiri
                    ...
                    Intent i = new Intent(TahapanKlasifikasi.this, PengertianKlasifikasiMh.class);
                    startActivity(i);
