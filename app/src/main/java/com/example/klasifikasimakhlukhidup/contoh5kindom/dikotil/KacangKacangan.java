...
public class KacangKacangan extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kacang_kacangan);
    }
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menuutama:
                startActivity(new Intent(KacangKacangan.this, hal2_menuutama.class));
                finish();break;
            case R.id.menumateribarr:
                startActivity(new Intent(KacangKacangan.this, hal10_menumateri.class));
                finish();break;

            case R.id.menusistemklasifikasi:
                startActivity(new Intent(KacangKacangan.this, PerkembanganSistemKlasifikasi.class));
                finish();break;
            case R.id.menusistemklasifikasi_plantae:
                startActivity(new Intent(KacangKacangan.this, kingdom_plantae.class));
                finish();break;
            case R.id.menusistemklasifikasi_plantae_biji:
                startActivity(new Intent(KacangKacangan.this, spermatophyta.class));
                finish();break;
            case R.id.menusistemklasifikasi_plantae_biji_tutup_dikotil:
                startActivity(new Intent(KacangKacangan.this, dikotil.class));
                finish();break;
        }
        return false;
    }
